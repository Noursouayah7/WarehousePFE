...
export function LandingPage() {
  return (
    <main className="overflow-hidden bg-[linear-gradient(180deg,_#f6f1e7_0%,_#faf7f0_30%,_#f7f6f2_100%)] text-[var(--foreground)]">
      <section className="relative isolate min-h-screen">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute left-[-10%] top-20 h-72 w-72 rounded-full bg-[#90a350]/25 blur-3xl" />
          <div className="absolute right-[-12%] top-40 h-96 w-96 rounded-full bg-[#c8b06d]/20 blur-3xl" />
        </div>
        ...
        <div className="relative mx-auto flex min-h-screen w-full max-w-7xl flex-col px-6 py-6 lg:px-10">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <Link href="/login" className="rounded-full border border-white/15 bg-white px-4 py-2 text-sm font-semibold text-[#24301a] transition hover:bg-[#f4ecd9]">
                Login
              </Link>
            </div>
          </motion.header>
          ...
          <div className="grid flex-1 items-center gap-10 py-12 lg:grid-cols-[1.08fr_0.92fr] lg:py-16">
            <motion.div className="max-w-3xl text-white" variants={container} initial="hidden" animate="visible">
              <motion.span
                variants={item}
                className="inline-flex rounded-full border border-white/18 bg-white/10 px-4 py-1 text-[11px] font-medium uppercase tracking-[0.28em] text-[#f5ead0] backdrop-blur"
              >
              ...
              <motion.div variants={item} className="mt-8 flex flex-wrap gap-3">
                <Link href="#products" className="rounded-full bg-[#eef0dc] px-6 py-3 text-sm font-semibold text-[#24301a] shadow-[0_16px_40px_rgba(0,0,0,0.18)] transition hover:-translate-y-0.5 hover:bg-white">
                  Discover Products
                </Link>
                ...
                <Link href="/register" className="rounded-full border border-[#c8b06d]/50 bg-[#c8b06d] px-6 py-3 text-sm font-semibold text-[#1f2613] transition hover:opacity-95">
                  Get Started
                </Link>
              </motion.div>
              ...
              <motion.div variants={item} className="mt-10 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                {stats.map((stat) => (
                  <div key={stat.label} className="rounded-3xl border border-white/14 bg-white/10 p-4 shadow-[0_12px_30px_rgba(6,10,5,0.16)] backdrop-blur-xl">
                    <p className="text-3xl font-semibold text-[#f7e7b8] [font-family:var(--font-display)]">{stat.value}</p>
              ...
              <div className="relative overflow-hidden rounded-[36px] border border-white/15 bg-white/12 p-5 shadow-[0_30px_80px_rgba(10,14,8,0.28)] backdrop-blur-2xl">
                <div className="rounded-[28px] border border-white/12 bg-[linear-gradient(180deg,rgba(247,240,223,0.18),rgba(255,255,255,0.04))] p-4">
                  <div className="grid gap-4 lg:grid-cols-[1.08fr_0.92fr]">
                    <div className="rounded-[28px] bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.30),transparent_35%),linear-gradient(180deg,#313f19_0%,#202815_100%)] p-5 text-white shadow-inner">
                      <p className="text-[10px] uppercase tracking-[0.3em] text-white/64">Olive grove to bottle</p>
                      <div className="mt-6 flex items-end gap-3">
                        <div className="h-20 w-10 rounded-t-full bg-[#7a8b44] shadow-[0_0_0_1px_rgba(255,255,255,0.10)]" />
                        <div className="h-28 w-10 rounded-t-full bg-[#55682e]" />
                        <div className="h-24 w-10 rounded-t-full bg-[#9db05b]" />
                        <div className="h-36 w-10 rounded-t-full bg-[#39451d]" />
                        <div className="h-18 w-10 rounded-t-full bg-[#b8a85e]" />
                      </div>
                    ...
                    <div className="grid gap-4">
                      <div className="rounded-[28px] border border-white/10 bg-white/84 p-5 text-[#26331a] shadow-sm">
                        <p className="text-[10px] uppercase tracking-[0.28em] text-[#6d744b]">Factory commitment</p>
                      ...
                      <div className="rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,#f8f1dd_0%,#efe3c4_100%)] p-5 text-[#2a321b] shadow-sm">
                        <p className="text-[10px] uppercase tracking-[0.28em] text-[#7b6a33]">Traceability</p>
                      ...
                      <div className="rounded-[28px] border border-white/10 bg-white/84 p-5 text-[#26331a] shadow-sm">
                        <p className="text-[10px] uppercase tracking-[0.28em] text-[#6d744b]">Innovation</p>
      ...
      <Section title="About the factory" subtitle="Premium production with modern operations">
        <div className="grid gap-5 lg:grid-cols-3">
          {[
            ...
            <motion.article key={title} variants={item} className="rounded-[28px] border border-[#e6ddc9] bg-white/88 p-6 shadow-[0_18px_40px_rgba(65,50,20,0.06)] backdrop-blur-sm">
              <div className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-[#eef0dc] text-[#4e5d2d]">✦</div>
      ...
      <Section id="products" title="Product showcase" subtitle="Export-quality olive oil products and premium packaging">
        <div className="grid gap-5 md:grid-cols-3">
          {products.map((product) => (
            <motion.article key={product.name} variants={item} whileHover={{ y: -6 }} className="group overflow-hidden rounded-[30px] border border-[#e6ddc9] bg-white p-5 shadow-[0_16px_40px_rgba(70,50,20,0.07)] transition-all">
              <div className={`h-64 rounded-[24px] bg-gradient-to-br ${product.tone} p-5 shadow-inner`}>
                <div className="flex h-full flex-col justify-between rounded-[22px] border border-white/15 bg-white/8 p-4 text-white backdrop-blur-sm">
                  ...
                  <div className="mt-auto flex items-end justify-between">
                    <div className="h-24 w-20 rounded-[24px_24px_34px_34px] bg-[linear-gradient(180deg,#f4e9b9_0%,#c7a74a_100%)] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.15)]" />
      ...
      <Section title="Why choose us" subtitle="Built for premium product confidence">
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          {chooseUs.map((title) => (
            <motion.article key={title} variants={item} whileHover={{ y: -5 }} className="rounded-[28px] border border-[#e6ddc9] bg-white p-6 shadow-[0_16px_35px_rgba(70,50,20,0.06)] transition">
              <div className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-2xl bg-[#efe6d1] text-[#6e5d28]">●</div>
              <h3 className="text-xl font-semibold tracking-tight [font-family:var(--font-display)]">{title}</h3>
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-[0.94fr_1.06fr]">
          <motion.article variants={item} className="rounded-[30px] border border-[#e6ddc9] bg-[#f8f3e6] p-6 shadow-sm">
            <p className="text-[10px] uppercase tracking-[0.28em] text-[#7b6a33]">Trust indicators</p>
          ...
          <motion.article variants={item} className="rounded-[30px] border border-[#e6ddc9] bg-white p-6 shadow-[0_16px_35px_rgba(70,50,20,0.06)]">
            <p className="text-[10px] uppercase tracking-[0.28em] text-[#7b6a33]">Testimonials</p>
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              {[
                ...
                <div key={quote} className="rounded-2xl border border-[#ece3cf] bg-[#fbf8f0] p-4 text-sm leading-7 text-[var(--muted-foreground)]">
                  {quote}
                </div>
              ))}
            </div>
...
function Section({
  ...
  return (
    <section id={id} className="mx-auto max-w-7xl px-6 py-20 lg:px-10">
      ...
      >
        <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-[#7b6a33]">{subtitle}</p>
        <h2 className="mt-3 text-3xl font-semibold tracking-tight text-[#24301a] lg:text-5xl [font-family:var(--font-display)]">{title}</h2>
